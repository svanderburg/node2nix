...
let
  sources = {
    ...
    "tar-3.1.13" = {
      ...
      version = "3.1.13";
      src = fetchurl {
        url = "https://registry.npmjs.org/tar/-/tar-3.1.13.tgz";
        sha512 = "2dl7xx4ap5d3qkp02840vmisaawnv1c2kmwz8n08xnmp58lziix35a8d21cxajvs7n3bgnhnb5lmd4138xhwyl1fm6i868mvzlxyd4c";
      };
    };
    "temp-0.8.3" = {
      name = "temp";
