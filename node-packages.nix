...
let
  sources = {
    ...
    "npm-registry-client-8.1.0" = {
      ...
      version = "8.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/npm-registry-client/-/npm-registry-client-8.1.0.tgz";
        sha1 = "ed7e5f58dfb98cb905f7b8adbf4858ce746db8d3";
      };
    };
    "npmconf-2.1.2" = {
      name = "npmconf";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."npm-registry-client-8.1.0" // {
        dependencies = [
