...
var switches = [
    ...
    ['-4', '--nodejs-4', 'Provides all settings to generate expression for usage with Node.js 4.x (default is: Node.js 6.x)'],
    ['-6', '--nodejs-6', 'Provides all settings to generate expression for usage with Node.js 6.x (default is: Node.js 6.x)'],
    ['-8', '--nodejs-8', 'Provides all settings to generate expression for usage with Node.js 8.x (default is: Node.js 6.x)'],
    ['--nodejs-10', 'Provides all settings to generate expression for usage with Node.js 10.x (default is: Node.js 6.x)'],
