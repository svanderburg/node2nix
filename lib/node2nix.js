...
function npmToNix(inputJSON, outputNix, compositionNix, nodeEnvNix, supplementJSON, supplementNix, production, includePeerDependencies, flatten, nodePackage, registryURL, noCopyNodeEnv, callback) {
    ...
    var deploymentConfig = new DeploymentConfig(registryURL, production, includePeerDependencies, flatten, nodePackage, outputDir);
    var expr;
