...
function npmToNix(inputJSON, outputNix, compositionNix, nodeEnvNix, lockJSON, supplementJSON, supplementNix, production, includePeerDependencies, flatten, nodePackage, registryURL, noCopyNodeEnv, callback) {
    ...
    var deploymentConfig = new DeploymentConfig(registryURL, production, includePeerDependencies, flatten, nodePackage, outputDir, lock);
    var expr;
