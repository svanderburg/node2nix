...
function npmToNix(inputJSON, outputNix, compositionNix, nodeEnvNix, lockJSON, supplementJSON, supplementNix, production, includePeerDependencies, flatten, nodePackage, registries, noCopyNodeEnv, bypassCache, fetchGitPackage, fetchGitRef, includeHash, stripOptionalDependencies, callback) {
    ...
    slasp.sequence([
        ...
        function(callback) {
            if(typeof obj == "object" && obj !== null) {
                if(Array.isArray(obj)) {
                    ...
                    // Parse package.json
                    expr = new PackageExpression(deploymentConfig, lock, baseDir, obj.name, fetchGitRef, baseDir, includeHash);
        ...
        function(callback) {
            expr = new CompositionExpression(compositionNix, nodePackage, nodeEnvNix, outputNix, supplementNix, (supplementJSON !== undefined), fetchGitPackage);
 ...
 * @param {String} fetchGitPackage Name of the fetchGit implementation to use (defaults to builtins.fetchGit)
