    ...
    slasp.sequence([
        ...
        function(callback, result) {
            ...
            if(resolvedVersion === null) {
                 ...
                 * optionalDependencies, then these dependencies are added to
                 * the regular dependencies as well. We must deduct them so that
                 * we only work with the mandatory dependencies. Otherwise,
                 * certain builds may fail, because optional dependencies can be
                 * broken.
                 *
                 * I'm actually quite curious to learn about the rational of this
                 * from the NPM developers.
                 */
                if(self.config.optionalDependencies !== undefined && self.config.dependencies !== undefined) {
