 ...
 * @param {?String} registryAuthToken URL of the NPM registry
 ...
 */
function NPMRegistrySource(baseDir, dependencyName, versionSpec, registryURL, registryAuthToken, stripOptionalDependencies) {
...
NPMRegistrySource.prototype.fetch = function(callback) {
    ...
    slasp.sequence([
        ...
        function(callback, client) {
            ...
            var clientParams = {};
            if (self.registryAuthToken) {
              clientParams.auth = {
                token: self.registryAuthToken,
                alwaysAuth: true,
              };
            }
