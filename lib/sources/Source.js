 ...
 */
Source.constructSource = function(registryURL, baseDir, outputDir, dependencyName, versionSpec, stripOptionalDependencies) {
    ...
    if(parsedVersionSpec !== null) { // If the version is valid semver range, fetch the package from the NPM registry
        return new NPMRegistrySource(baseDir, dependencyName, parsedVersionSpec, registryURL, stripOptionalDependencies);
        ...
        return new NPMRegistrySource(baseDir, dependencyName, versionSpec, registryURL, stripOptionalDependencies);
    }
};
...
Source.prototype.convertIntegrityStringToNixHash = function(integrity) {
    ...
    } else if(integrity.substr(0, 7) === "sha256-") {
        this.hashType = "sha256";
        this.sha256 = integrity.substring(7);
