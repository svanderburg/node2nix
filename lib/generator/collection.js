 ...
 */
function generateCollectionExpr(packageSet, dependencies, production, includePeerDependencies, flatten, callback) {
    var body = {};
    var i;
            ...
            slasp.from(function(callback) {
                ...
                slasp.sequence([
                    function(callback) {
                        ...
                        packageSet.resolveDependencies(null, dependency, callback);
                    },
                   
                    function(callback, resolvedDependencies) {
                           ...
                           callback(null, resolvedDependencies);
                            ...
                            slasp.sequence([
                                function(callback) {
                                    ...
                                    packageSet.generatePackageArgsExpr(metadata, production, includePeerDependencies, callback);
                                },
