...
var package = require('./generator/package.js');
var collection = require('./generator/collection.js');
    ...
    slasp.sequence([
        ...
        function(callback) {
            if(typeof obj == "object" && obj !== null) {
                ...
                if(Array.isArray(obj))
                    collection.collectionToRegistryExpr(baseDir, obj, linkDependencies, registryURL, callback);
                else
                    package.packageObjectToRegistryExpr(baseDir, obj, production, linkDependencies, registryURL, callback);
            } else {
        ...
        function(callback) {
            if(typeof obj == "object" && obj !== null) {
                ...
                if(Array.isArray(obj))
                    compositionStr = collection.collectionToCompositionExpr(outputNix, nodeEnvNix);
                else
                    compositionStr = package.packageObjectToCompositionExpr(obj, outputNix, nodeEnvNix);
