 ...
 */
function npmToNix(inputJSON, outputNix, compositionNix, nodeEnvNix, production, includePeerDependencies, flatten, nodePackage, registryURL, callback) {
    ...
    slasp.sequence([
        ...
        function(callback) {
            var compositionExpr = compositionGenerator.generateCompositionExpr(nodeEnvNix, nodePackage, outputNix);
