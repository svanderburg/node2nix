 ...
 */
function npmToNix(inputJSON, outputNix, compositionNix, nodeEnvNix, production, includePeerDependencies, registryURL, callback) {
        ...
        function(callback) {
            if(typeof obj == "object" && obj !== null) {
                ...
                if(Array.isArray(obj)) {
                    collectionGenerator.generateCollectionExpr(packageSet, obj, production, includePeerDependencies, callback);
                } else {
                    packageGenerator.generatePackageExpr(packageSet, obj, new nijs.NixFile({ value: "./." }), production, includePeerDependencies, callback);
                }
            } else {
