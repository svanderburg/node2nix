...
function fetchMetaDataFromGit(dependencyName, versionSpec, callback) {
    ...
    slasp.sequence([
        ...
        function(callback) {
            ...
            /* Resolve the hash of the actual revision */
            ...
            gitRevParse.on("close", function(code) {
                if(code != 0)
                    rev = "origin/" + commitIsh + "\n"; // If git rev-parse fails, we consider the commitIsh a branch/tag. We must add origin/ in front to make checkout work
