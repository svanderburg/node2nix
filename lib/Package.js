    ...
    if(dependencies === undefined) {
        ...
        slasp.fromEach(function(callback) {
            ...
            if(self.isBundledDependency(dependencyName)) {
                ...
                var pkg = new Package(self.deploymentConfig, self, dependencyName, versionSpec, self.source.baseDir, true /* Never include development dependencies of transitive dependencies */, self.sourcesCache);
                ...
                slasp.sequence([
                    ...
                    function(callback) {
                        ...
                        self.requiredDependencies[dependencyName] = pkg;
...
Package.prototype.resolveDependenciesFromLockedDependencies = function(dependencyObj, callback) {
    ...
    if(dependencyObj.dependencies === undefined) {
        ...
        slasp.fromEach(function(callback) {
            ...
            var pkg = new Package(self.deploymentConfig, self, dependencyName, dependency.version, self.source.baseDir, true /* Never include development dependencies of transitive dependencies */, self.sourcesCache);
...
Package.prototype.resolveDependencies = function(callback) {
    if(this.deploymentConfig.lock === undefined) { // If no lock file is present, let the tool fetch all dependencies and metadata
        this.resolveDependenciesAndSources(callback);
    } else { // If we have a lock file, use that to generate Nix expressions
        this.resolveDependenciesFromLockedDependencies(this.deploymentConfig.lock, callback);
    }
};
