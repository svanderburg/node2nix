    ...
    if(dependencyObj.dependencies === undefined) {
        ...
        slasp.fromEach(function(callback) {
            ...
            if(dependency.bundled) { // Bundled dependencies should not be included
                ...
                var pkg = new Package(self.deploymentConfig, self.lock, self, dependencyName, gitRef, dependency.version, includeHash, self.source.baseDir, self.production, self.sourcesCache);
