 ...
 * @param {Object} lock Contents of a package lock file (optional)
 */
function DeploymentConfig(registryURL, production, includePeerDependencies, flatten, nodePackage, outputDir, bypassCache, lock) {
