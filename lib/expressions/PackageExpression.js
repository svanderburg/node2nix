 ...
 */
function PackageExpression(deploymentConfig, lock, baseDir, name, gitRef, versionSpec, includeHash) {
    OutputExpression.call(this);
    this.package = new Package(deploymentConfig, lock, null, name, gitRef, "./.", includeHash, baseDir, deploymentConfig.production, this.sourcesCache);
}
        ...
        nodeDependencies: new nijs.NixFunInvocation({
            ...
            paramExpr: new nijs.NixFunInvocation({
                funExpr: new nijs.NixFunInvocation({
                    funExpr: new nijs.NixExpression("lib.overrideExisting"),
                    paramExpr: new nijs.NixExpression("args")
                }),
                paramExpr: {
