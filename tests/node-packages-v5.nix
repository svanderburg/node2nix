...
let
  sources = {
    ...
    "dmp-0.1.1" = {
      ...
      version = "0.1.1";
      src = fetchurl {
        url = "http://registry.npmjs.org/dmp/-/dmp-0.1.1.tgz";
    ...
    "floorine-0.3.0" = {
      ...
      version = "0.3.0";
      src = fetchurl {
        url = "http://registry.npmjs.org/floorine/-/floorine-0.3.0.tgz";
    ...
    "fsevents-1.0.8" = {
      ...
      version = "1.0.8";
      src = fetchurl {
        url = "http://registry.npmjs.org/fsevents/-/fsevents-1.0.8.tgz";
        sha1 = "4fc72faaa31a307b8f140160000940e420c27bc5";
      };
    };
    "native-diff-match-patch-0.3.1" = {
      ...
      version = "0.3.1";
      src = fetchurl {
        url = "http://registry.npmjs.org/native-diff-match-patch/-/native-diff-match-patch-0.3.1.tgz";
    ...
    "strftime-0.9.2" = {
      ...
      version = "0.9.2";
      src = fetchurl {
        url = "http://registry.npmjs.org/strftime/-/strftime-0.9.2.tgz";
...
in
{
  ...
  "express-git+https://github.com/strongloop/express.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "4bcbf67482471ac096fb39bf076ba5d40c0fe4da";
      sha256 = "272d5a5e22b54bb4e62182135c6cec95e4c86c5d714fc47a5b237671fe3d9f23";
    };
    dependencies = [
  ...
  "nijs-svanderburg/nijs" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "15524d43fe29befa99107fa0c5ceb76472e8c5f5";
      sha256 = "758b3d68c58602563c0ffa927d968779681a9b503cc0185eed195930b11f6fce";
    };
    dependencies = [
      sources."optparse-1.0.5"
      sources."slasp-0.0.4"
  ...
  "lodash-github:lodash/lodash" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "2ab57dd374fa58385962784d44e93ae8153cb1fb";
      sha256 = "48fccb143d9b00fb0dcc54c71052bea4490558fe44a6c1d0634a5968b6b10243";
    };
    meta = {
    };
    production = true;
  ...
  floomatic = nodeEnv.buildNodePackage {
    ...
    version = "0.5.3";
    src = fetchurl {
      url = "http://registry.npmjs.org/floomatic/-/floomatic-0.5.3.tgz";
  ...
  "@sindresorhus/df" = nodeEnv.buildNodePackage {
    ...
    version = "1.0.1";
    src = fetchurl {
      url = "http://registry.npmjs.org/@sindresorhus/df/-/df-1.0.1.tgz";
