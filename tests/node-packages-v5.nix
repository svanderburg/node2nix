...
in
{
  ...
  "express-git+https://github.com/strongloop/express.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "9375a9afa9d7baa814b454c7a6818a7471aaef00";
      sha256 = "8bcf2c8bf8a34b86ff498edea95127c67eff3f9e1e2e7fa430550ee818dd0d50";
    };
    dependencies = [
  ...
  "nijs-svanderburg/nijs" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      sha256 = "78237b29347a5ecb6d5b6d6f7f459a54f13a133e5839ca896d817c8b5db8d7e5";
    };
    dependencies = [
      sources."optparse-1.0.5"
      sources."slasp-0.0.4"
  ...
  "lodash-github:lodash/lodash" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "2926ba97e44dc505d77a6c45e7beabdf242c06b1";
      sha256 = "b27f9f5b16fcabee5193df140b966b60c56cb714b3cc7807c42eadf317627fd5";
    };
    meta = {
      license = "MIT";
    };
