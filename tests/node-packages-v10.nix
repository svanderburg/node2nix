...
in
{
  ...
  "express-git+https://github.com/strongloop/express.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "5596222f6a6e0eea74f6fb38915b071d98122a2f";
      sha256 = "d6728bcdd92d214533fdf55a6a1ae73d2b8c5e5c09d5043f07c2e743bee275ee";
    };
    dependencies = [
  ...
  "js-sequence-diagrams-git+https://github.com/codimd/js-sequence-diagrams.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "8bf65a6449c7ecdfd4b969dd5556e39e56d013da";
      sha256 = "f190d579cd1d4c7c4f8e2b5f5e27a1af50bd4ff693e3a8e81c3492ba99f381d4";
    };
    dependencies = [
      sources."eve-0.5.4"
  ...
  "lodash-github:lodash/lodash" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "86a852fe763935bb64c12589df5391fd7d3bb14d";
      sha256 = "38a18330a7a670c0ac33669661799a00134f7295423dbd8af53741543b302038";
    };
    buildInputs = globalBuildInputs;
    meta = {
      license = "MIT";
  ...
  node-libcurl = nodeEnv.buildNodePackage {
    ...
    version = "2.2.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/node-libcurl/-/node-libcurl-2.2.0.tgz";
      sha512 = "dyv3IuQBqO4KK5ojtM4k6FuBA3RxZjTqO4c+MUirwvlTY7qIH2oNSws8Xte1pp2aso9TuXyAwxS/g3ZqmAk8aA==";
    };
    dependencies = [
      sources."abbrev-1.1.1"
      sources."ajv-6.12.4"
