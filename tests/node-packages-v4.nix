...
in
{
  ...
  "express-git+https://github.com/strongloop/express.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "d2e6e3381ccbabfe300166afc75c432aee961ece";
      sha256 = "3e77c886ca0c92f2484b3c0033a4c6e7276e839b5367bc91d24e3626efff1285";
    };
    dependencies = [
  ...
  "lodash-github:lodash/lodash" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "d985dbffb89e5fa13505ed93449b9fec1fbf973b";
      sha256 = "8dd7176b3738c0398d832c35247323a7fc4a2a4fe4f916d078c6f270a4971ca8";
    };
    buildInputs = globalBuildInputs;
    meta = {
      license = "MIT";
