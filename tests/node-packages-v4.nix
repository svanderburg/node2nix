...
in
{
  ...
  "express-git+https://github.com/strongloop/express.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "0e88dceac2b86fbc066cd0f042d093e838604d0d";
      sha256 = "c6b557f686bc58546ec7cfa9dbb879af9c7c0b26f65f9189d4dc3bc32797d7d9";
    };
    dependencies = [
  ...
  "lodash-github:lodash/lodash" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "f73b35bb497dd8948dcfa97a6924bf5ee860d467";
      sha256 = "f7808a545a8c06c23c13700ebd57a094a29b35a90446e37593ab0fb83b28edb7";
    };
    buildInputs = globalBuildInputs;
    meta = {
      license = "MIT";
