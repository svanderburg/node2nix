...
in
{
  ...
  "express-git+https://github.com/strongloop/express.git" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "0083372bed2df35abf56ac882bd42f01bd6cff39";
  ...
  "lodash-github:lodash/lodash" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "c1f805f4972843b675056b2786f1165f7db81737";
      sha256 = "078150a3eaf590ebb675cc0c4b9a001f67c1e2249511f196e6c77d86c797f13b";
    };
    buildInputs = globalBuildInputs;
    meta = {
      license = "MIT";
